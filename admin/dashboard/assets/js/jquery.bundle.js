...
/*! DataTables 1.10.18 Â©2008-2018 SpryMedia Ltd - datatables.net/license */
!(function (t) {
  "function" == typeof define && define.amd
      ...
      e.scrollBarVis !== r && e.scrollBarVis !== a
        ...
        : ((e.scrollBarVis = r),
          ...
          I &&
            pt(function (t, e) {
              ((t.innerHTML =
                '<div class="dataTables_sizing">' + N[e] + "</div>"),
                (t.childNodes[0].style.height = "0"),
                (t.childNodes[0].style.overflow = "hidden"),
                (t.style.width = P[e]));
            }, o),
  ...
  ((Vt = function (e, n) {
    ...
    Xt("draw()", function (t) {
      return this.iterator("table", function (e) {
        "page" === t
          ? O(e)
          : ("string" == typeof t && (t = "full-hold" !== t), k(e, !1 === t));
      });
    }),
    Xt("page()", function (t) {
      return t === a
      ...
      function (r) {
        ...
        return De(
          ...
          function (e) {
            ...
            if ((o || (o = Te(r, i)), null !== n && -1 !== t.inArray(n, o)))
              return [n];
      ...
      var r = this.iterator("column", function (n, r) {
        ...
        if (e !== a && u.bVisible !== e) {
          ...
          ((u.bVisible = e),
            ...
            H(n, n.aoFooter),
            n.aiDisplay.length ||
              t(n.nTBody).find("td[colspan]").attr("colspan", b(n)),
            It(n));
        }
      });
      return (
          ...
          return De(
            ...
            function (e) {
              ...
              return t.isPlainObject(e)
                ? e.column !== a && e.row !== a && -1 !== t.inArray(e.row, g)
                  ? [e]
                  : []
                : (r = S.filter(e)
                      .map(function (t, e) {
...
/*! Clipboard.js v2.0.1 * https://zenorocha.github.io/clipboard.js *  * Licensed MIT Â© Zeno Rocha */
!(function (t, e) {
